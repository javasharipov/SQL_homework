...
select * , case when Price > 1000 then 'High' else 'Low' end checkPrice from Products
...
SELECT *, CASE  WHEN DepartmentName = 'HR' OR EmployeeID = 5 THEN Salary * 0.10 END FROM Employees;	
